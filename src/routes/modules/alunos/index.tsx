...
import VisualizarAlunos from "pages/modules/alunos/Visualizar/Visualizar";
...
export default [
    ...
    <AuthRoute path="/alunos/visualizar" component={VisualizarAlunos} permission="reader" key="/alunos/visualizar" isPrivate exact />,
